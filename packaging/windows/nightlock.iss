...
AppPublisherURL=https://github.com/res138/nightlock
AppSupportURL=https://github.com/res138/nightlock/issues
AppUpdatesURL=https://github.com/res138/nightlock/releases
AppCopyright=Copyright (C) Nightlock contributors
DefaultDirName={autopf}\Nightlock
DefaultGroupName=Nightlock
DisableProgramGroupPage=yes
OutputBaseFilename=Nightlock-{#AppVersion}-Windows-Setup
SetupIconFile=..\..\apps\desktop\resources\nightlock.ico
VersionInfoCompany=Nightlock contributors
VersionInfoCopyright=Copyright (C) Nightlock contributors
VersionInfoDescription=Nightlock installer
VersionInfoOriginalFileName=Nightlock-{#AppVersion}-Windows-Setup.exe
VersionInfoProductName=Nightlock
